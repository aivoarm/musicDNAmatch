                                ...
                                {!selectedVideo ? (
                                    ...
                                    <motion.div key="complete" initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="w-full space-y-10">
                                        ...
                                        <div className="flex gap-4">
                                            <Link href="/match" className="flex-1 bg-[#FF0000] text-white font-black py-6 rounded-[2rem] hover:scale-[1.03] active:scale-95 transition-all shadow-[0_0_30px_rgba(255,0,0,0.4)] flex items-center justify-center gap-3 text-lg uppercase tracking-widest">
